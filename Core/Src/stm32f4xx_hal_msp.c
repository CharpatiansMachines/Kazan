...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA7     ------> ADC1_IN7
    */
    HAL_GPIO_DeInit(GPIOA, LINE_SENSOR_2_1_Pin|LINE_SENSOR_2_2_Pin|LINE_SENSOR_2_3_Pin|LINE_SENSOR_3_1_Pin
                          |LINE_SENSOR_3_2_Pin|LINE_SENSOR_3_3_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB1     ------> ADC2_IN9
    */
    HAL_GPIO_DeInit(TRIMPOT_0_GPIO_Port, TRIMPOT_0_Pin);

    HAL_GPIO_DeInit(TRIMPOT_1_GPIO_Port, TRIMPOT_1_Pin);

    HAL_GPIO_DeInit(GPIOB, LINE_SENSOR_0_Pin|LINE_SENSOR_1_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PA0-WKUP     ------> UART4_TX
    */
    HAL_GPIO_DeInit(UART4_TX_DATA_GPIO_Port, UART4_TX_DATA_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA9     ------> USART1_TX
    */
    HAL_GPIO_DeInit(USART1_TX_SABERTOOTH_GPIO_Port, USART1_TX_SABERTOOTH_Pin);
